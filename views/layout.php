...
<body>
    ...
    <div style="background-image: url(https://bootstrapious.com/i/snippets/sn-static-header/background.jpg);" class="jumbotron bg-cover text-white">
        <div class="container py-5 text-center">
            <h1 class="display-4 font-weight-bold">App MVC</h1>
            <p class="font-italic mb-0">Esta es una app de prueba con la cual podrás crear una que otra cosa...</p>
        </div>
    </div>
            ...
            <div class="container overflow-hidden">
                <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                    <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div class="widget">
                            <a href="#!">
                                <img src="https://bootstrapbrain.com/demo/components/footers/footer-2/assets/img/bsb-logo.svg" alt="BootstrapBrain Logo" width="175" height="57">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-3 col-xl-2">
